---
title: "Xorg Configuration Reference"
type: reference
entities: [Monitor, Device, Screen, Display, Modeline]
created: 2025-11-30
authors: [docs-team]
tags: [xorg, xorg.conf.d, modesetting, vmware, vesa, modeline, cvt]
---
...
**Пример конфига:** [examples/10-monitor.conf](examples/10-monitor.conf)
...
### В этом репозитории
- [Пример конфига](examples/10-monitor.conf) — готовый к использованию конфиг
- [LightDM display-setup-script](../gui/display/01-lightdm-monitor-bootstrap.md) — автоматическая настройка через LightDM
- [Тестирование и отладка](../gui/display/02-testing-and-debugging.md) — xrandr, логи, диагностика
- [Systemd monitor-bootstrap](../systemd/monitor-bootstrap.md) — systemd unit для настройки монитора
